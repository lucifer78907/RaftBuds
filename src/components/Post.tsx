    ...
    return (
        <article className="flex flex-col gap-4 mt-8 shadow-lg p-4 bg-neutral-50 rounded-xl">
            <header className="flex gap-4 items-center">
                ...
                <div>
                    <h2 className="text-base sm:text-xl text-neutral-700 font-semibold">{post.author.username}</h2>
                    <p className="text-sm sm:text-base text-neutral-500">{post.author.email}</p>
                </div>
            </header>
            <main className="flex flex-col gap-4">
                <p className="text-base sm:text-lg text-neutral-800 font-medium">{post.title}
                ...
                <p className="text-base  text-neutral-800">{post.content}</p>
